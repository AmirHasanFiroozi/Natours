...
${this.indentString.repeat(this.indentLevel)}`;if(this.previousToken?.type==="dot"){let e=pt(this.tokens,this.currentIndex),n;switch(e?.val){case"script":{n=Pt(ct(this.tokens,this.currentIndex));break}case"style":{n="css";break}default:break}if(n){let o=this.currentIndex+1,s=this.tokens[o],a="",u=!1;for(;s&&s.type!=="end-pipeless-text";){switch(s.type){case"text":{a+=s.val;break}case"newline":{a+=`
